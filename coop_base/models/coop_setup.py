...
class CoopSetup(models.AbstractModel):
    ...
    def _setup_branding(self):
        ...
        Заголовок короткий: движок дописывает к нему имя открытой
        записи, и длинная строка превращала вкладку в нечитаемую ленту.
        Имя COOPTECH при этом остаётся в интерфейсе — оно короткое и там
        не мешает.
        """
        params = self.env['ir.config_parameter'].sudo()
        branding = {
            'web_debranding.new_name': 'COOPTECH',
            'web_debranding.new_title': 'Социально-экономическая платформа',
        }
        changed = []
