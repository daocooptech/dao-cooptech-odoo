...
MOCKUP_ORDER = [
    ...
    # Владелец 22 сентября 2026: «добавить пункт в меню после
    # управление проектами». Документы нужны сразу нескольким
    # разделам — сделкам, закупкам, проектам, членству, — и
    # спрятанные во вкладку одного из них стали бы недоступны
    # остальным.
    (78, 'coop_documents.menu_coop_documents_root', None),
    ...
    # Штатный складской модуль движка. Назван «Управлением складом»,
    # чтобы не совпадать с нашим разделом «Склады»: до 23 сентября
    # 2026 оба звались «Склад», и в обычном режиме понять, какой
    # нужен, было неоткуда.
    (180, 'stock.menu_stock_root', 'Управление складом'),
