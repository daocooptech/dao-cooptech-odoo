...
patch(ControlPanel.prototype, {
    ...
    /**
     * Своя страница узнаётся по признаку действия, которым её открыли.
     * На чужой карточке признака нет: туда приходят из каталога людей, и
     * там и хлебные крошки, и переключение записей на своих местах.
     */
    get coopIsProfile() {
        return Boolean(this.env.searchModel?.globalContext?.coop_my_page);
    }
