...
export class CoopSidebar extends Component {
    ...
    /**
     * «Добавить» вверху меню ведёт на свою страницу.
     *
     * Там уже стоят кнопки «Добавить» у каждой полосы: ресурс, проект,
     * вакансия, потребность. Своего списка «что можно завести» здесь
     * нет намеренно — он разошёлся бы с полосами при первом же новом
     * разделе.
     */
    openAdd() {
        return this.action.doAction("coop_profile.action_coop_my_page");
    }
