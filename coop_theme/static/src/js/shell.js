...
export class CoopTabs extends Component {
    ...
    refresh() {
        ...
        // любом экране, у которого нет своего пункта, а такой на
        // платформе есть: «Сообщения» открываются штатным действием
        // переписки, тогда как сам пункт меню перевешен на наш экран.
        // Действие и пункт расходятся, условие срабатывало каждый раз, и
        // переписка переставала подгружаться.
        //
