...
""",
    ...
    'version': '19.0.1.0.0',
    'license': 'LGPL-3',
    'depends': ['coop_base', 'coop_people', 'coop_orgs', 'coop_resources', 'coop_skills', 'coop_vacancies', 'coop_projects', 'coop_communities', 'coop_attributes', 'coop_deals', 'coop_wallet', 'coop_bounty', 'product', 'project', 'hr_skills', 'sale_management'],
    'data': [
