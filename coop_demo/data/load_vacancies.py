...
def load_vacancies(env):
    ...
    for index, row in enumerate(rows):
        ...
        # Публиковать вакансию может только участник с подтверждённой
        # личностью (решение владельца). У демонстрационных людей
        # подтверждение проставляем: иначе загруженный каталог не
        # опубликуется собственным же правилом.
        if not owner.is_company and not owner.coop_verified:
            owner.coop_verified = True
