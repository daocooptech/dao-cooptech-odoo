...
def load_communities(env):
    ...
    for index, row in enumerate(rows):
        ...
        # Состав пересобирается, только если его нет или некому вести.
        #
        # Раньше сверялось число участников с задуманным — и получалась
        # перетяжка: выравнивание полок убирает у человека лишние
