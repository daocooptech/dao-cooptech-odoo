...
# Названий должно хватать на весь каталог: шесть штук на сто двадцать
# выпусков — это шесть названий с разными номерами, на которых не видно
# ни поиска, ни отбора. Взяты требования, какие кооперативы и правда
# выпускают: поставка, работы, аренда, заём.
CFA_NAMES = [
    ...
    'Требование по поставке картофеля нового урожая',
    'Требование по поставке молока на переработку',
    'Денежное требование по договору подряда на кровлю',
    'Требование по передаче мёда с пасеки',
    'Обязательство по оплате аренды складского места',
    'Требование по поставке сена в рулонах',
    'Денежное требование по договору перевозки',
    'Требование по поставке саженцев питомника',
    'Обязательство по возврату средств целевой программы',
    'Требование по оплате пусконаладки оборудования',
    'Требование по поставке мясной продукции',
    'Денежное требование по договору хранения',
    'Требование по поставке овощей закрытого грунта',
    'Обязательство по оплате услуг сушильного комплекса',
    'Требование по поставке шерсти мытой',
    'Денежное требование по договору на переработку пластика',
    'Требование по поставке сыра и творога',
    'Обязательство по оплате монтажа солнечных панелей',
]
